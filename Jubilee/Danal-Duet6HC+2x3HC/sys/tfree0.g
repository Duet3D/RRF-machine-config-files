...
G53 G0 X12       F10000       ; Rapid to the approach position with tool-0. (park_x, park_y - offset).  X next to make a square move. 
G53 G0 X12  Y320 F10000       ; Rapid to the approach position with tool-0. (park_x, park_y - offset)
G53 G1 Y355 F6000             ; Controlled move to the park position with tool-0. (park_x, park_y)
...
G53 G0 Y250 F10000	          ; Rapid to a position where a future tool change won't hurt anything by returning to this position via its G60 S2
