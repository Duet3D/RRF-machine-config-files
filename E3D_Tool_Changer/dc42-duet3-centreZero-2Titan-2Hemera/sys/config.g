...
M584 E3:4:23.0					; set extruder drivers (tool 2 missing)
...
;*** Add a 4th E parameter in each of the following 4 lines when tool 2 is fitted
...
M307 H0 A590.6 C474.5 D4.4 V24.0		; Heater 0 tuning results
...
; Tool 2 heater and sensor disabled for now
;M308 S3 P"22.temp0" Y"thermistor" T100000B4725 C7.06e-8
...
;*** Uncomment the following 2 lines when tool 2 is fitted
...
M563 P2 S"T2" D2 H4 F8 					; Define tool 2 the same as tool 3 for now
G10 P2 X23 Y41 Z-5.4  					; Set tool 2 axis offsets
G10 P2 R0 S0 							; Reset initial tool 2 active and standby temperatures to 0C

;*** Change D2 in the following line to D3 when tool 2 is fitted
M563 P3 S"T3" D2 H4 F8 					; Define tool 3 (uses extruder 2 until we have tool 2)
